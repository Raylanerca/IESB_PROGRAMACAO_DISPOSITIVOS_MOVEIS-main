  ...
  const salvarPet = async () => {
    ...
    try {
      ...
      if (petToEdit) {
        ...
        const updatedPets = pets.map(p =>
          p.id === petToEdit.id
            ? {
                ...
                idNotificacao: undefined, // Será atualizado abaixo
              }
            : p
        );

        // Agenda nova notificação e atualiza o pet com o id da notificação
        ...
        petAtualizado.idNotificacao = idNotificacao;
